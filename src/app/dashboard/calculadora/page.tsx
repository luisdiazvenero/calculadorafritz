...
export default function CalculadoraGenericaPage() {
  const [form, setForm] = useState<FormState>(DEFAULTS);

  const previewEntry = {
    id: "calc-generic",
    distributorId: "generic",
    periodYear: 2026,
    periodMonth: 2,
  ...
  function Field({
    label, description, fieldKey, type,
    icon: Icon, colSpan = 1,
  }: {
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">Ingresa valores y ve los resultados en tiempo real</p>
      </div>
        ...
        <div className="flex flex-col gap-3 sticky top-6">
          <div className="rounded-2xl border border-gray-200 shadow-sm overflow-hidden" style={{ backgroundColor: "#f7f7f7" }}>
            <div className="grid grid-cols-5 text-sm font-semibold text-white" style={{ backgroundColor: "#1e2a3a" }}>
              <div className="px-4 py-3.5 col-span-2">SIMULACIÓN</div>
