              ...
              {tableRows.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className="px-3 py-3 text-center tabular-nums font-semibold border-l border-gray-200 flex items-center justify-center"
                    ...
                    <div
                      className="px-3 py-3 text-center tabular-nums font-bold border-l border-gray-200 flex items-center justify-center"
